...
| 機能名 | 対象ページ | 概要 |
| :--- | :--- | :--- |
| **manaba自動ログイン** | `https://gakunin-idp.c.chuo-u.ac.jp/*` | 認証画面で「ログイン」ボタンを1秒後に自動クリック |
...
| **シラバス検索リンクの追加** | `https://room.chuo-u.ac.jp/ct/course_*` | コースヘッダーの講義名末尾に、講義名・教員名で直接検索できるシラバスリンクを追加 |
